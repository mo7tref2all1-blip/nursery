...
async function initDB() {
    ...
    `);
        ...
        if (tc[0].cnt === 0) {
            await conn.execute('INSERT INTO teachers (name, subject, phone, salary, join_date) VALUES (?,?,?,?,?),(?,?,?,?,?),(?,?,?,?,?)', ['سارة أحمد', 'رياضيات', '0501234567', 5000, '2023-01-15',
        ...
        if (sc[0].cnt === 0) {
            await conn.execute(`INSERT INTO students (name, age, class_group, parent_name, parent_phone, join_date) VALUES
